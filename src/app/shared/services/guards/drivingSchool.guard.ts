...
export class DrivingSchoolGuard implements CanActivate, CanActivateChild, CanLoad {
        ...
        return this._authService.check()
            .pipe(
                switchMap((authenticated) => {
                    ...
                    // Allow the access
                    if (this.roles.find(r => r.role === RolesConstants.AUTOESCOLA || r.role === RolesConstants.EDRIVING)) {
                        return of(true);
                    }
